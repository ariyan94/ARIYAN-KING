...
def ud():
    ...
    if opt == '1':
        os.system('xdg-open https://youtube.com/@who.is.king135')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] JOINE MY FACEBOOK GRUP')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m CHOOSE OPTION >>> ')
    if opt == '1':
        os.system('xdg-open https://facebook.com/groups/198147722729321/')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100084159245405')
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@who.is.king135')
        return None
